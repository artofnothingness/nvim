...
let bg_visible = get(nvim_get_hl_by_name('CursorLineNR', 1), 'background', '#000000')
...
hi default link BufferVisible      CursorLineNR
hi default link BufferVisibleMod   CursorLineNR
hi default link BufferVisibleSign  CursorLineNR
