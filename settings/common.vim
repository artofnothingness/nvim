...
" Folding
set foldlevelstart=999 " Start editing with all folds open.
set foldmethod=indent " Use indent model for folding mechanism.

" Backup
set backupdir=~/.config/nvim/autoload/cache/backup/// " The directory for backup files.
set directory=~/.config/nvim/autoload/cache/swap// " The directory for swap files.
set undodir=~/.config/nvim/autoload/cache/undo// " The directory for undo files.
...
set viewdir=~/.config/nvim/autoload/cache/view// " Name of the directory where to store files for :mkview.
